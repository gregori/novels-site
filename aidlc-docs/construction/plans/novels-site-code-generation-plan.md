...
- [x] **Step 1 — Project Structure Setup** (greenfield)
      ...
      _Traceability_: enables all stories.
...
- [x] **Step 2 — Content Layer & Business Logic Generation**
      ...
      _Traceability_: Story 1, Story 2, Story 3, Story 4, Story 9; BR-1 to BR-6, BR-8.
...
- [x] **Step 3 — Business Logic Unit Testing**
      ...
      _Traceability_: BR-8, NFR Requirements (Vitest + fast-check decision).
...
- [x] **Step 5 — Layout & Global Styles Generation**
      ...
      _Traceability_: Story 6, Story 7; NFR Design (CSP, silent-degradation), NFR Requirements (WCAG 2.1 AA).
...
- [x] **Step 6 — Shared UI Components Generation**
      ...
      _Traceability_: Story 2, Story 3, Story 4, Story 6, Story 7, Story 8; frontend-components.md.
...
- [x] **Step 7 — Reading UI Runtime Client Scripts**
      ...
      _Traceability_: Story 7, Story 4; BR-6, BR-7.
...
- [x] **Step 9 — Pages Generation**
      ...
      _Traceability_: Story 2, Story 3, Story 4, Story 5, Story 6, Story 8, Story 9.
...
- [x] **Step 11 — Sample Content Creation**
      ...
      _Traceability_: Story 1 (validates the authoring convention end-to-end).
